...
public class GameListController {
    ...
    public ResponseEntity<Void> move(@PathVariable Long listId, @RequestBody MoveDTO body) {
    ...
    public static class MoveDTO {
        ...
        public void setDestinationIndex(int destinationIndex) { this.destinationIndex = destinationIndex; }
    }
}
